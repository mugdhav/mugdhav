### Hi there 👋! I am Mugdha Vairagade. 

Technical Writer and AI Developer building tools at the intersection of documentation and intelligent systems.

Currently focused on: MCP servers · agentic workflows · AI tooling for technical writers · developer documentation

→ Portfolio and writing samples: [vmugdha.in](https://www.vmugdha.in)  
→ LinkedIn: [@mugdhav](https://www.linkedin.com/in/mugdhav)
→ Twitter/X: [@vmugdha](https://x.com/vmugdha)
...
- [Local Media Search MCP Server](https://github.com/mugdhav/local_media_search_mcp_server) - A Python MCP server that enables AI agents to search across local media sources. Integrates with MCP-compatible clients to surface local media content -image and videos - with natural language search. Demo: [mugdhav-mediasearchmcp.hf.space](https://mugdhav-mediasearchmcp.hf.space) 
...
- [Startup Analyzer](https://ai.studio/apps/drive/1BQ4qO7IU4pwYhYBmQ9eTLy-tLE6v51OJ) - AI-powered startup evaluation tool for venture capitalists, built with Gemini API and Google AI Studio. You can try it out [here](https://ai.studio/apps/drive/1BQ4qO7IU4pwYhYBmQ9eTLy-tLE6v51OJ).  
***
